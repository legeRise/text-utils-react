...
export default function About() {
    ...
    const changeMode = () => {
      if (myStyles.color === 'white') {
        //   color 'white' means mode was dark  changing it to 'light'
          setMyStyles({
              color : 'black',
              backgroundColor : 'white'
            })

        // giving an option to apply dark mode again
        setBtnText('Enable Dark Mode')
        }
         else if(myStyles.color === 'black') {
            setMyStyles({
                color : 'white',
    ...
    return (
        <div className='container' style={myStyles}>
            ...
            <div className='container'><button type="button" className='btn btn-primary my-2' onClick={changeMode}>{btnText}</button></div>
